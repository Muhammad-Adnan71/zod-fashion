    ...
    <main>
      ...
      <section className="py-10">
        <Banner
          dataContent={{
            mainBanner,
            button,
            mainHeading: mainBanner.mainFashionPageHeading,
            mainBannerText: mainBanner.mainFashionPageText,
          }}
          slides={BannerSlides}
      ...
      <section className=" relative pb-36 overflow-hidden " id="formSection">
        <Image
          src={Pattern4}
          alt=""
          className="w-[40%] absolute bottom-[28%] -left-[7%] z-[10] max-lg:hidden"
        />
        <Image
          src={Pattern3}
          alt=""
          className="w-[25%] absolute bottom-[30%] right-[-150px] z-[10] max-lg:hidden"
        />
            ...
            >
              <span
                dangerouslySetInnerHTML={{
                  __html: sliderSection.fashionSliderHeading,
                }}
              ></span>
            </h2>
          </div>
