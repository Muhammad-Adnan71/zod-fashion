...
export default function ModestWear({
  dictionary,
  slides,
}: {
  dictionary: any;
    ...
    <main>
      ...
      <section className="py-10">
        <Banner
          dataContent={{
            mainBanner,
            button,
            mainHeading: mainBanner.mainModestWearHeading,
            mainBannerText: mainBanner.mainModestWearPageText,
          }}
          slides={ModestBannerSlides}
          handleModalClick={handleModal}
        />

        <div className="text-center md:hidden mt-5">
          <GetInTouch text={button.getInTouch} />
        </div>
      </section>
      ...
      <section className=" relative pb-36 overflow-hidden " id="formSection">
        ...
        <div className="w-[80%] mx-auto max-sm:w-[90%]">
          ...
          >
            {formSection.fashionFormHeading}
          </h2>
          <ContactForm
            formContent={{
              ...formSection,
      ...
      <section className="w-full my-24 relative max-lg:my-16 max-md:my-10">
        <div className="absolute z-[10] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-sm:hidden">
          <div className="flex justify-center items-center">
            <h2
              ...
              className="text-[50px] font-heading text-white text-center max-xl:text-[40px] max-lg:text-[30px] max-md:text-[25px]"
            >
              <span
                dangerouslySetInnerHTML={{
                  __html: sliderSection.modestWearSliderHeading,
                }}
              ></span>
            </h2>
          </div>
        ...
        <CategorySlider
          isMobile={true}
          slides={slides}
          heading={sliderSection.modestWearSliderHeading}
        />
      </section>
      ...
      <AboutSection
        ...
        description={aboutSection.descriptionForModestWear}
      ...
      <section className="w-[70%] mx-auto py-24 max-xl:w-[80%] max-lg:w-[90%] max-sm:py-10">
        ...
        >
          <span
            dangerouslySetInnerHTML={{
              __html: whyZodSection.modestWearSubHeading,
            }}
          ></span>
        </p>
      ...
      {isModalOpen && (
        <ContactModal
          ...
          sourceName="Modest Wear"
          mainHeading={"<b>Get Customize Trending Designs Now</b>"}
