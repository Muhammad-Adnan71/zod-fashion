    ...
    <main>
      ...
      <section className="py-10">
        <Banner
          dataContent={{
            mainBanner,
            button,
            mainHeading: mainBanner.mainLeatherHeading,
            mainBannerText: mainBanner.mainLeatherText,
          }}
          slides={LeatherBannerSlide}
          handleModalClick={handleModal}
          headingClass="!text-[20px] max-xl:!text-[18px] max-xl:!w-full max-sm:!text-[15px]"
          subHeadingClass="!text-[40px] max-xl:!text-[30px] max-sm:!text-[25px] !w-full"
        />
      ...
      <section className=" relative pb-36 overflow-hidden " id="formSection">
        <Image
          src={Pattern4}
          alt=""
          className={`max-w-[430px] w-[30%] bottom-[32%] -left-[4%] absolute z-[10] max-lg:hidden`}
        />
        <Image
          src={Pattern3}
          alt=""
          className={`max-w-[317px] w-[22%] absolute bottom-[30%] right-[-150px] z-[10] max-lg:hidden`}
        />
        ...
        <div className="w-[80%] mx-auto max-sm:w-[90%]">
          ...
          >
            {formSection.leatherFormHeading}
          </h2>
          <ContactForm
            formContent={{
              ...formSection,
      ...
      <section className="w-full my-24 relative max-lg:my-16 max-md:my-10">
        <div className="absolute z-[10] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] max-sm:hidden">
          <div className="flex justify-center items-center">
            <h2
              ...
              className="text-[50px] font-semibold font-heading text-white text-center max-xl:text-[40px] max-lg:text-[30px] max-md:text-[25px] text-shadow-color"
            >
              <span
                dangerouslySetInnerHTML={{
                  __html: sliderSection.leatherSliderHeading,
                }}
              ></span>
            </h2>
          </div>
        ...
        <CategorySlider
          isMobile={true}
          slides={slides}
          heading={sliderSection.leatherSliderHeading}
        />
      </section>
      ...
      <AboutSection
        ...
        description={aboutSection.descriptionForLeather}
        ...
        <div className="grid grid-cols-3 gap-5 max-md:grid-cols-2 max-sm:grid-cols-1">
          <div className="bg-[#353444] bg-opacity-10 p-10 rounded-[10px] min-h-[300px] max-lg:p-5 max-lg:min-h-[250px] max-sm:min-h-fit max-sm:p-5">
            ...
            <p
              ...
              data-section="helpSection"
              data-key="trendingDesignsText"
            >
              {helpSection.trendingDesignsText}
            </p>
          </div>
          <div className="bg-[#353444] bg-opacity-10 p-10 rounded-[10px] min-h-[300px] max-lg:p-5 max-lg:min-h-[250px] max-sm:min-h-fit max-sm:p-5">
            <h2 className="text-[#DB0718] font-heading font-semibold text-[50px] max-lg:text-[40px] max-sm:text-[35px]">
            ...
            <h3
              data-section="helpSection"
              data-key="freeCustomizationTitle"
              className="text-black font-heading font-semibold text-[25px] pb-3 max-lg:text-[20px] "
            >
              {helpSection.freeCustomizationTitle}
            </h3>
            <p
              className="text-black font-heading text-[18px] max-lg:text-[16px] max-sm:text-[14px]"
              data-section="helpSection"
              data-key="freeCustomizationText"
            >
              {helpSection.freeCustomizationText}
            </p>
          </div>
          <div className="bg-[#353444] bg-opacity-10 p-10 rounded-[10px] min-h-[300px] max-lg:p-5 max-lg:min-h-[250px] max-sm:min-h-fit max-sm:p-5">
            <h2 className="text-[#DB0718] font-heading font-semibold text-[50px] max-lg:text-[40px] max-sm:text-[35px]">
      ...
      <section className="w-[70%] mx-auto py-24 max-xl:w-[80%] max-lg:w-[90%] max-sm:py-10">
        <h2
          ...
          data-key="fashionWhyZodHeading"
          className="text-[60px] text-black leading-tight font-heading pb-5 text-center font-extralight max-xl:text-[40px]  max-sm:text-[35px]"
        >
          <span
            dangerouslySetInnerHTML={{
        ...
        <p
          data-section="whyZodSection"
          data-key="fashionWhyZodSubHeading"
          className="text-[40px] text-[#DB0718] leading-tight font-heading pb-10 text-center w-[70%] mx-auto max-xl:text-[30px] max-sm:text-[18px] max-sm:w-full"
        >
          <span
            dangerouslySetInnerHTML={{
              __html: whyZodSection.fashionWhyZodSubHeading,
            }}
          ></span>
        </p>
        <div className="grid grid-cols-3 max-[400px]:grid-cols-1">
          <div className="p-10  text-center max-lg:p-5 max-sm:p-2 max-[400px]:w-[200px] max-[400px]:mx-auto">
            ...
            <h3
              data-section="whyZodSection"
              data-key="lowerMinimumOrderQuantityTitle"
            ...
            <p
              data-section="whyZodSection"
              data-key="lowerMinimumOrderQuantityText"
          ...
          <div className="p-10 text-center min-[400px]:border-r-[1px] min-[400px]:border-l-[1px] min-[400px]:border-[#FF0000] max-lg:p-5 max-sm:p-2 max-[400px]:w-[200px] max-[400px]:mx-auto">
            ...
            <h3
              data-section="whyZodSection"
              data-key="moreAffordablePricingTitle"
              className="text-black font-heading font-semibold text-[25px] pb-3 flex-nowrap max-xl:text-[20px] max-sm:text-[16px] max-[500px]:text-[13px]  max-[400px]:text-[14px]"
            >
            ...
            <p
              data-section="whyZodSection"
              data-key="moreAffordablePricingText"
              className="text-black font-heading text-[18px] max-xl:text-[15px] max-sm:text-[13px] max-[500px]:text-[10px] max-[400px]:text-[12px]"
            >
              <span
                dangerouslySetInnerHTML={{
      ...
      {isModalOpen && (
        <ContactModal
          ...
          sourceName="leather jackets"
          mainHeading={formSection.fashionFormHeading}
        />
      )}
    </main>
  );
